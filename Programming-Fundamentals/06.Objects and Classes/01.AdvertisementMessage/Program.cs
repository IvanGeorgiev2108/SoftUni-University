...
namespace _01.AdvertisementMessage
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RandomGenerator city = new RandomGenerator(new List<string>() { "Burgas", "Sofia", "Plovdiv", "Varna", "Ruse" });
            Console.WriteLine($"{phrases.GetRandomPhrase()} {events.GetRandomPhrase()} {authors.GetRandomPhrase()} – {city.GetRandomPhrase()}.");
        }
    }
